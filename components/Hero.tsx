...
export default function Hero({ content }: HeroProps) {
  ...
  return (
    <section 
      className="relative text-white min-h-[600px] flex items-center justify-center"
      style={{
    ...
    >
      <div className="relative max-w-7xl mx-auto px-4 text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link 
            href="/products" 
            className="inline-block bg-white text-ranch-brown px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg min-w-[160px]"
          >
            Shop Now
          </Link>
          <Link 
            href="/about-golden-hills-ranch" 
            className="inline-block border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-ranch-brown transition-colors min-w-[160px]"
          >
            Our Story
          </Link>
        </div>
