    ...
    <div>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our premium selection of grass-fed beef cuts and essential cooking accessories.
          </p>
        </div>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto bg-white">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Browse our carefully curated selection of premium beef and cooking essentials.
          </p>
        </div>
